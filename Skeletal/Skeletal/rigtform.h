...
inline RigTForm interpolate(const RigTForm& q0, const RigTForm& q1, const double a) {
	Cvec3 t = q0.getTranslation() * (1 - a) + q1.getTranslation() * a;
	Quat r = slerp(q0.getRotation(), q1.getRotation(), a);
